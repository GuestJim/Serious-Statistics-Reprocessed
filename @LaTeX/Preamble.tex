...
\lstnewenvironment{styleR}
{
	...
	\lstset{
		language			=	R,
		morekeywords		=	{READ, reLoc, reAPI, labelRound, labelBreak, labelDisp, BoxPerc, meanMS, meanGEO, normGRO, percMS, ecdfFPS, statMS, qqslope, statGRAPH, sepCOL, addFPS, compTAB, customSave, subOUT, dataSEL, sinkTXT, OCCHTML, tableHTML, replace_html, writeOCC, sinkHTML, sinkOUT, graphMEANS, graphCOURSE, graphDIFF, graphFREQ, graphQQ, graphOUT},
	}
...
\lstnewenvironment{stylePy}
{
	...
	\lstset{
		language			=	Python,
		morekeywords		=	{CSVlistR, listclean, numFind, numGen},
	}
	%	by specifying the language here, it will load up its options, but still use the options set above
}	{
	% \endminipage
...
\newcommand{\para}[1]{\%\~{}#1}
\newcommand{\vari}[1]{\%#1\%}
%	create commands to label the batch parameters and variables automatically, since they use special characters
